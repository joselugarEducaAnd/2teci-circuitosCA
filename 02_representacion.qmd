---
page-layout: full  # <--- ESTA LÍNEA ES VITAL
---
...
::: {#fig-circuito1 layout-align="center"}
![](media/ejemploSinusoidal.png){width="50%"}
:::
...
* **Forma polar:** $U = U_{p} \angle \varphi$.
* **Forma compleja:** $U = U_{p} \cos \varphi + j \cdot \sin \varphi$. En Electrotecnia se utiliza **$j$** para no confundirla con la intensidad. Representa un **giro de +90°**.
...
$$I=I_{p}\angle \varphi=3\phase{-60º} \, \text{A}$$

o, expresando el ángulo en radianes:

$$I=I_{p}\angle \varphi=3\phase{-\pi /3} \, \text{A}$$

La representación en forma de número complejo es:

$$I=I_{p}\cos \varphi + j \cdot I_{p} \sen \varphi=3·\cos(-60º)+j·3·\sen(-60º)=1,5-1,5\sqrt{3}j\, \text{A}$$

Y, por último, la representación gráfica sería:

::: {#fig-circuito1 layout-align="center"}
![](media/fasor_final_blanco.png){width="70%"}
:::
