...
d)  Calcular la potencia activa, reactiva y aparente. *(Nota: Tómese para todo el problema como origen de fases la tensión del generador)*.
...
::: {.callout-note appearance="simple"}
**Solución:** $\vec{I}=31,39\phase{-19,80^{\circ}}$ A.\
Factor de potencia: $\cos\varphi = 0,94$.
:::

### Problema 10 {.unnumbered}
