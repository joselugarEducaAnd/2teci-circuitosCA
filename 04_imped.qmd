...
::: {.callout-important style="width:90%;margin:auto"}
## Ejemplo
**Dada una resistencia de $5 \ \Omega$ y una inductancia de $50 \text{ mH}$ que están trabajando a 50 Hz, calcula la impedancia equivalente en los siguientes casos:**\
...
a) Calcula la reactancia capacitiva $X_C$.
...
a) Expresa la impedancia total del componente.
b) Si duplicamos la frecuencia a $120 \ \text{Hz}$, ¿cuál sería la nueva impedancia?
...
a) Determina la parte real ($R$) y la parte imaginaria ($X$).
b) ¿Es una carga inductiva o capacitiva? Calcula el valor de $L$ o $C$ correspondiente.
...
* *Solución:* $a) \ R=30 \ \Omega ;b) \ X_c=26,46 \ \Omega; c) \ \vec{Z} = 40 \phase{-41,41^\circ} \ \Omega$.
...
* *Solución:* $a) \ 6,93 \ \text{A} ;b) \ 31,75 \ \Omega; c) \ 63,66 \ \text{mH}$.
:::